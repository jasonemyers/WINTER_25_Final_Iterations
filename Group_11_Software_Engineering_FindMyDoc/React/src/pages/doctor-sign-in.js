...
import ctaBanner from '../assets/CTA-banner.jpg';                                // CTA image
import ctaBottomVector from '../assets/CTA-bottom-pluse-vector.svg';             // CTA bottom vector
import ctaTopEllipse from '../assets/CTA-top-ellipse-shape.svg';                 // CTA ellipse
...
export default function SignInDoctors() {
  ...
  const handleLogout = () => {
    ...
    navigate('/sign-out');                                          // redirect after logout
  };

  // on form submit, go to dashboard
  const handleSubmit = (e) => {
    e.preventDefault();                                             // prevent reload
    // auth logic here if needed
    navigate('/dashboard');                                         // route to dashboard
  };

  return (
    <div className="signInDoctorsPage">                             {/* main wrapper */}
      {/* Header Begin */}
            ...
            <div className="footer-content">
              <div className="footer-block">
                ...
                <div className="footer-address">
                  Empowering wellness through knowledge and care              {/* tagline */}
                </div>
              </div>
            </div>
